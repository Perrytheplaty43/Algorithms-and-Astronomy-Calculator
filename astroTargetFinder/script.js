...
if (window.location.search.length != 0) {
    ...
    document.getElementById("indicator2").textContent = "Logged in as: " + user
...
function onSubmit(event) {
    if (event.submitter.id == "home_button") {
        ...
        if (navigator.geolocation) {
            ...
            document.getElementById("p1").textContent = "Geolocation is not supported by this browser.";
        }
...
function updateUI(final, timer, lat, long, final2) {
    if (final != null) {
        if (final.length == 1) {
            document.getElementById("p1").textContent = "Best target: " + (() => { let firstChar = final[0][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[0][0].split(""); if (firstChar[0] == "I") { return final[0][0].substring(1) } else { return final[0][0] } })() + ", Magnitude: " + final[0][2] + ", Type: " + final[0][3] + ", Constellation: " + final[0][4] + "\n";
        } else if (final.length == 2) {
            document.getElementById("p1").textContent = "Best target: " + (() => { let firstChar = final[0][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[0][0].split(""); if (firstChar[0] == "I") { return final[0][0].substring(1) } else { return final[0][0] } })() + ", Magnitude: " + final[0][2] + ", Type: " + final[0][3] + ", Constellation: " + final[0][4] + "\n" +
                "2nd best target: " + (() => { let firstChar = final[1][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[1][0].split(""); if (firstChar[0] == "I") { return final[1][0].substring(1) } else { return final[1][0] } })() + ", Magnitude: " + final[1][2] + ", Type: " + final[1][3] + ", Constellation: " + final[1][4] + "\n";
        } else if (final.length == 3) {
            document.getElementById("p1").textContent = "Best target: " + (() => { let firstChar = final[0][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[0][0].split(""); if (firstChar[0] == "I") { return final[0][0].substring(1) } else { return final[0][0] } })() + ", Magnitude: " + final[0][2] + ", Type: " + final[0][3] + ", Constellation: " + final[0][4] + "\n" +
                "2nd best target: " + (() => { let firstChar = final[1][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[1][0].split(""); if (firstChar[0] == "I") { return final[1][0].substring(1) } else { return final[1][0] } })() + ", Magnitude: " + final[1][2] + ", Type: " + final[1][3] + ", Constellation: " + final[1][4] + "\n" +
                "3rd best target: " + (() => { let firstChar = final[2][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[2][0].split(""); if (firstChar[0] == "I") { return final[2][0].substring(1) } else { return final[2][0] } })() + ", Magnitude: " + final[2][2] + ", Type: " + final[2][3] + ", Constellation: " + final[2][4] + "\n";
        } else if (final.length == 4) {
            document.getElementById("p1").textContent = "Best target: " + (() => { let firstChar = final[0][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[0][0].split(""); if (firstChar[0] == "I") { return final[0][0].substring(1) } else { return final[0][0] } })() + ", Magnitude: " + final[0][2] + ", Type: " + final[0][3] + ", Constellation: " + final[0][4] + "\n" +
                "2nd best target: " + (() => { let firstChar = final[1][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[1][0].split(""); if (firstChar[0] == "I") { return final[1][0].substring(1) } else { return final[1][0] } })() + ", Magnitude: " + final[1][2] + ", Type: " + final[1][3] + ", Constellation: " + final[1][4] + "\n" +
                "3rd best target: " + (() => { let firstChar = final[2][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[2][0].split(""); if (firstChar[0] == "I") { return final[2][0].substring(1) } else { return final[2][0] } })() + ", Magnitude: " + final[2][2] + ", Type: " + final[2][3] + ", Constellation: " + final[2][4] + "\n" +
                "4th best target: " + (() => { let firstChar = final[3][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[3][0].split(""); if (firstChar[0] == "I") { return final[3][0].substring(1) } else { return final[3][0] } })() + ", Magnitude: " + final[3][2] + ", Type: " + final[3][3] + ", Constellation: " + final[3][4] + "\n";
        } else {
            document.getElementById("p1").textContent = "Best target: " + (() => { let firstChar = final[0][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[0][0].split(""); if (firstChar[0] == "I") { return final[0][0].substring(1) } else { return final[0][0] } })() + ", Magnitude: " + final[0][2] + ", Type: " + final[0][3] + ", Constellation: " + final[0][4] + "\n" +
                "2nd best target: " + (() => { let firstChar = final[1][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[1][0].split(""); if (firstChar[0] == "I") { return final[1][0].substring(1) } else { return final[1][0] } })() + ", Magnitude: " + final[1][2] + ", Type: " + final[1][3] + ", Constellation: " + final[1][4] + "\n" +
                "3rd best target: " + (() => { let firstChar = final[2][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[2][0].split(""); if (firstChar[0] == "I") { return final[2][0].substring(1) } else { return final[2][0] } })() + ", Magnitude: " + final[2][2] + ", Type: " + final[2][3] + ", Constellation: " + final[2][4] + "\n" +
        ...
        document.getElementById("p1").textContent = "No targets found for the search params, try widening the search."
    }
    if (final2.length != 0) {
        if (final2.length == 1) {
            document.getElementById("p2").textContent = "Favorites: \n \n Best target: " + (() => { let firstChar = final2[0][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[0][0].split(""); if (firstChar[0] == "I") { return final2[0][0].substring(1) } else { return final2[0][0] } })() + ", Magnitude: " + final2[0][2] + ", Type: " + final2[0][3] + ", Constellation: " + final2[0][4] + "\n";
        } else if (final2.length == 2) {
            document.getElementById("p2").textContent = "Favorites: \n \n Best target: " + (() => { let firstChar = final2[0][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[0][0].split(""); if (firstChar[0] == "I") { return final2[0][0].substring(1) } else { return final2[0][0] } })() + ", Magnitude: " + final2[0][2] + ", Type: " + final2[0][3] + ", Constellation: " + final2[0][4] + "\n" +
                "2nd best target: " + (() => { let firstChar = final2[1][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[1][0].split(""); if (firstChar[0] == "I") { return final2[1][0].substring(1) } else { return final2[1][0] } })() + ", Magnitude: " + final2[1][2] + ", Type: " + final2[1][3] + ", Constellation: " + final2[1][4] + "\n";
        } else if (final2.length == 3) {
            document.getElementById("p2").textContent = "Favorites: \n \n Best target: " + (() => { let firstChar = final2[0][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[0][0].split(""); if (firstChar[0] == "I") { return final2[0][0].substring(1) } else { return final2[0][0] } })() + ", Magnitude: " + final2[0][2] + ", Type: " + final2[0][3] + ", Constellation: " + final2[0][4] + "\n" +
                "2nd best target: " + (() => { let firstChar = final2[1][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[1][0].split(""); if (firstChar[0] == "I") { return final2[1][0].substring(1) } else { return final2[1][0] } })() + ", Magnitude: " + final2[1][2] + ", Type: " + final2[1][3] + ", Constellation: " + final2[1][4] + "\n" +
                "3rd best target: " + (() => { let firstChar = final2[2][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[2][0].split(""); if (firstChar[0] == "I") { return final2[2][0].substring(1) } else { return final2[2][0] } })() + ", Magnitude: " + final2[2][2] + ", Type: " + final2[2][3] + ", Constellation: " + final2[2][4] + "\n";
        } else if (final2.length == 4) {
            document.getElementById("p2").textContent = "Favorites: \n \n Best target: " + (() => { let firstChar = final2[0][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[0][0].split(""); if (firstChar[0] == "I") { return final2[0][0].substring(1) } else { return final2[0][0] } })() + ", Magnitude: " + final2[0][2] + ", Type: " + final2[0][3] + ", Constellation: " + final2[0][4] + "\n" +
                "2nd best target: " + (() => { let firstChar = final2[1][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[1][0].split(""); if (firstChar[0] == "I") { return final2[1][0].substring(1) } else { return final2[1][0] } })() + ", Magnitude: " + final2[1][2] + ", Type: " + final2[1][3] + ", Constellation: " + final2[1][4] + "\n" +
                "3rd best target: " + (() => { let firstChar = final2[2][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[2][0].split(""); if (firstChar[0] == "I") { return final2[2][0].substring(1) } else { return final2[2][0] } })() + ", Magnitude: " + final2[2][2] + ", Type: " + final2[2][3] + ", Constellation: " + final2[2][4] + "\n" +
                "4th best target: " + (() => { let firstChar = final2[3][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[3][0].split(""); if (firstChar[0] == "I") { return final2[3][0].substring(1) } else { return final2[3][0] } })() + ", Magnitude: " + final2[3][2] + ", Type: " + final2[3][3] + ", Constellation: " + final2[3][4] + "\n";
        } else {
            document.getElementById("p2").textContent = "Favorites: \n \n Best target: " + (() => { let firstChar = final2[0][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[0][0].split(""); if (firstChar[0] == "I") { return final2[0][0].substring(1) } else { return final2[0][0] } })() + ", Magnitude: " + final2[0][2] + ", Type: " + final2[0][3] + ", Constellation: " + final2[0][4] + "\n" +
                "2nd best target: " + (() => { let firstChar = final2[1][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[1][0].split(""); if (firstChar[0] == "I") { return final2[1][0].substring(1) } else { return final2[1][0] } })() + ", Magnitude: " + final2[1][2] + ", Type: " + final2[1][3] + ", Constellation: " + final2[1][4] + "\n" +
                "3rd best target: " + (() => { let firstChar = final2[2][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[2][0].split(""); if (firstChar[0] == "I") { return final2[2][0].substring(1) } else { return final2[2][0] } })() + ", Magnitude: " + final2[2][2] + ", Type: " + final2[2][3] + ", Constellation: " + final2[2][4] + "\n" +
        ...
        document.getElementById("p2").textContent = "No favorites found."
    }
    document.getElementById("timerLable").textContent = "Computed in:" + (new Date() - timer) / 1000 + "s";
...
function save(inputs, timesUNIX) {
    ...
    document.getElementById("condition").textContent = "Weather Contition: " + condition;
}
