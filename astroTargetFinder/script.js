const mapImages = {
    ...
    'I2490': './Images/IC2490.jpg',
    'I2480': './Images/IC2480.jpg',
    'I2475': './Images/IC2475.jpg',
    'I2478': './Images/IC2478.jpg',
    '4236': './Images/NGC4236.jpg',
    '5005': './Images/NGC5005.jpg',
    '4647': './Images/NGC4647.jpg',
    '4486': './Images/NGC4486.jpg',
    '5236': './Images/NGC5236.jpg',
...
function updateUI(final, timer, lat, long, final2) {
    if (final[0] != 'null') {
        ...
        if (final.length == 1) {
            document.getElementById("p1").innerHTML = "Best target: " + (() => { let firstChar = final[0][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[0][0].split(""); if (firstChar[0] == "I") { return final[0][0].substring(1) } else { return final[0][0] } })() + ", Magnitude: " + (() => { if (final[0][2] == "") { return "N/A" } else { return final[0][2] } })() + ", Type: " + final[0][3] + ", Constellation: " + final[0][4] + ", Visability Score: " + Math.round(final[0][5] * 100) / 100 + "<br />";
        } else if (final.length == 2) {
            document.getElementById("p1").innerHTML = "Best target: " + (() => { let firstChar = final[0][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[0][0].split(""); if (firstChar[0] == "I") { return final[0][0].substring(1) } else { return final[0][0] } })() + ", Magnitude: " + (() => { if (final[0][2] == "") { return "N/A" } else { return final[0][2] } })() + ", Type: " + final[0][3] + ", Constellation: " + final[0][4] + ", Visability Score: " + Math.round(final[0][5] * 100) / 100 + "<br />" +
                "2nd best target: " + (() => { let firstChar = final[1][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[1][0].split(""); if (firstChar[0] == "I") { return final[1][0].substring(1) } else { return final[1][0] } })() + ", Magnitude: " + (() => { if (final[1][2] == "") { return "N/A" } else { return final[1][2] } })() + ", Type: " + final[1][3] + ", Constellation: " + final[1][4] + ", Visability Score: " + Math.round(final[1][5] * 100) / 100 + "<br />";
        } else if (final.length == 3) {
            document.getElementById("p1").innerHTML = "Best target: " + (() => { let firstChar = final[0][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[0][0].split(""); if (firstChar[0] == "I") { return final[0][0].substring(1) } else { return final[0][0] } })() + ", Magnitude: " + (() => { if (final[0][2] == "") { return "N/A" } else { return final[0][2] } })() + ", Type: " + final[0][3] + ", Constellation: " + final[0][4] + ", Visability Score: " + Math.round(final[0][5] * 100) / 100 + "<br />" +
                "2nd best target: " + (() => { let firstChar = final[1][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[1][0].split(""); if (firstChar[0] == "I") { return final[1][0].substring(1) } else { return final[1][0] } })() + ", Magnitude: " + (() => { if (final[1][2] == "") { return "N/A" } else { return final[1][2] } })() + ", Type: " + final[1][3] + ", Constellation: " + final[1][4] + ", Visability Score: " + Math.round(final[1][5] * 100) / 100 + "<br />" +
                "3rd best target: " + (() => { let firstChar = final[2][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[2][0].split(""); if (firstChar[0] == "I") { return final[2][0].substring(1) } else { return final[2][0] } })() + ", Magnitude: " + (() => { if (final[2][2] == "") { return "N/A" } else { return final[2][2] } })() + ", Type: " + final[2][3] + ", Constellation: " + final[2][4] + ", Visability Score: " + Math.round(final[2][5] * 100) / 100 + "<br />";
        } else if (final.length == 4) {
            document.getElementById("p1").innerHTML = "Best target: " + (() => { let firstChar = final[0][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[0][0].split(""); if (firstChar[0] == "I") { return final[0][0].substring(1) } else { return final[0][0] } })() + ", Magnitude: " + (() => { if (final[0][2] == "") { return "N/A" } else { return final[0][2] } })() + ", Type: " + final[0][3] + ", Constellation: " + final[0][4] + ", Visability Score: " + Math.round(final[0][5] * 100) / 100 + "<br />" +
                "2nd best target: " + (() => { let firstChar = final[1][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[1][0].split(""); if (firstChar[0] == "I") { return final[1][0].substring(1) } else { return final[1][0] } })() + ", Magnitude: " + (() => { if (final[1][2] == "") { return "N/A" } else { return final[1][2] } })() + ", Type: " + final[1][3] + ", Constellation: " + final[1][4] + ", Visability Score: " + Math.round(final[1][5] * 100) / 100 + "<br />" +
                "3rd best target: " + (() => { let firstChar = final[2][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[2][0].split(""); if (firstChar[0] == "I") { return final[2][0].substring(1) } else { return final[2][0] } })() + ", Magnitude: " + (() => { if (final[2][2] == "") { return "N/A" } else { return final[2][2] } })() + ", Type: " + final[2][3] + ", Constellation: " + final[2][4] + ", Visability Score: " + Math.round(final[2][5] * 100) / 100 + "<br />" +
                "4th best target: " + (() => { let firstChar = final[3][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[3][0].split(""); if (firstChar[0] == "I") { return final[3][0].substring(1) } else { return final[3][0] } })() + ", Magnitude: " + (() => { if (final[3][2] == "") { return "N/A" } else { return final[3][2] } })() + ", Type: " + final[3][3] + ", Constellation: " + final[3][4] + ", Visability Score: " + Math.round(final[3][5] * 100) / 100 + "<br />";
        } else {
            document.getElementById("p1").innerHTML = "Best target: " + (() => { let firstChar = final[0][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[0][0].split(""); if (firstChar[0] == "I") { return final[0][0].substring(1) } else { return final[0][0] } })() + ", Magnitude: " + (() => { if (final[0][2] == "") { return "N/A" } else { return final[0][2] } })() + ", Type: " + final[0][3] + ", Constellation: " + final[0][4] + ", Visability Score: " + Math.round(final[0][5] * 100) / 100 + "<br />" +
                "2nd best target: " + (() => { let firstChar = final[1][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[1][0].split(""); if (firstChar[0] == "I") { return final[1][0].substring(1) } else { return final[1][0] } })() + ", Magnitude: " + (() => { if (final[1][2] == "") { return "N/A" } else { return final[1][2] } })() + ", Type: " + final[1][3] + ", Constellation: " + final[1][4] + ", Visability Score: " + Math.round(final[1][5] * 100) / 100 + "<br />" +
                "3rd best target: " + (() => { let firstChar = final[2][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[2][0].split(""); if (firstChar[0] == "I") { return final[2][0].substring(1) } else { return final[2][0] } })() + ", Magnitude: " + (() => { if (final[2][2] == "") { return "N/A" } else { return final[2][2] } })() + ", Type: " + final[2][3] + ", Constellation: " + final[2][4] + ", Visability Score: " + Math.round(final[2][5] * 100) / 100 + "<br />" +
                "4th best target: " + (() => { let firstChar = final[3][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[3][0].split(""); if (firstChar[0] == "I") { return final[3][0].substring(1) } else { return final[3][0] } })() + ", Magnitude: " + (() => { if (final[3][2] == "") { return "N/A" } else { return final[3][2] } })() + ", Type: " + final[3][3] + ", Constellation: " + final[3][4] + ", Visability Score: " + Math.round(final[3][5] * 100) / 100 + "<br />" +
                "5th best target: " + (() => { let firstChar = final[4][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final[4][0].split(""); if (firstChar[0] == "I") { return final[4][0].substring(1) } else { return final[4][0] } })() + ", Magnitude: " + (() => { if (final[4][2] == "") { return "N/A" } else { return final[4][2] } })() + ", Type: " + final[4][3] + ", Constellation: " + final[4][4] + ", Visability Score: " + Math.round(final[4][5] * 100) / 100;
        }
    } else {
    ...
    if (final2 != undefined) {
        if (final2.length != 0) {
            if (final2.length == 1) {
                document.getElementById("p2").innerHTML = "Favorites: <br /> <br /> Best target: " + (() => { let firstChar = final2[0][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[0][0].split(""); if (firstChar[0] == "I") { return final2[0][0].substring(1) } else { return final2[0][0] } })() + ", Magnitude: " + (() => { if (final2[0][2] == "") { return "N/A" } else { return final2[0][2] } })() + ", Type: " + final2[0][3] + ", Constellation: " + final2[0][4] + ", Visability Score: " + Math.round(final2[0][5] * 100) / 100 + "<br />";
            } else if (final2.length == 2) {
                document.getElementById("p2").innerHTML = "Favorites: <br /> <br /> Best target: " + (() => { let firstChar = final2[0][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[0][0].split(""); if (firstChar[0] == "I") { return final2[0][0].substring(1) } else { return final2[0][0] } })() + ", Magnitude: " + (() => { if (final2[0][2] == "") { return "N/A" } else { return final2[0][2] } })() + ", Type: " + final2[0][3] + ", Constellation: " + final2[0][4] + ", Visability Score: " + Math.round(final2[0][5] * 100) / 100 + "<br />" +
                    "2nd best target: " + (() => { let firstChar = final2[1][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[1][0].split(""); if (firstChar[0] == "I") { return final2[1][0].substring(1) } else { return final2[1][0] } })() + ", Magnitude: " + (() => { if (final2[1][2] == "") { return "N/A" } else { return final2[1][2] } })() + ", Type: " + final2[1][3] + ", Constellation: " + final2[1][4] + ", Visability Score: " + Math.round(final2[1][5] * 100) / 100 + "<br />";
            } else if (final2.length == 3) {
                document.getElementById("p2").innerHTML = "Favorites: <br /> <br /> Best target: " + (() => { let firstChar = final2[0][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[0][0].split(""); if (firstChar[0] == "I") { return final2[0][0].substring(1) } else { return final2[0][0] } })() + ", Magnitude: " + (() => { if (final2[0][2] == "") { return "N/A" } else { return final2[0][2] } })() + ", Type: " + final2[0][3] + ", Constellation: " + final2[0][4] + ", Visability Score: " + Math.round(final2[0][5] * 100) / 100 + "<br />" +
                    "2nd best target: " + (() => { let firstChar = final2[1][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[1][0].split(""); if (firstChar[0] == "I") { return final2[1][0].substring(1) } else { return final2[1][0] } })() + ", Magnitude: " + (() => { if (final2[1][2] == "") { return "N/A" } else { return final2[1][2] } })() + ", Type: " + final2[1][3] + ", Constellation: " + final2[1][4] + ", Visability Score: " + Math.round(final2[1][5] * 100) / 100 + "<br />" +
                    "3rd best target: " + (() => { let firstChar = final2[2][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[2][0].split(""); if (firstChar[0] == "I") { return final2[2][0].substring(1) } else { return final2[2][0] } })() + ", Magnitude: " + (() => { if (final2[2][2] == "") { return "N/A" } else { return final2[2][2] } })() + ", Type: " + final2[2][3] + ", Constellation: " + final2[2][4] + ", Visability Score: " + Math.round(final2[2][5] * 100) / 100 + "<br />";
            } else if (final2.length == 4) {
                document.getElementById("p2").innerHTML = "Favorites: <br /> <br /> Best target: " + (() => { let firstChar = final2[0][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[0][0].split(""); if (firstChar[0] == "I") { return final2[0][0].substring(1) } else { return final2[0][0] } })() + ", Magnitude: " + (() => { if (final2[0][2] == "") { return "N/A" } else { return final2[0][2] } })() + ", Type: " + final2[0][3] + ", Constellation: " + final2[0][4] + ", Visability Score: " + Math.round(final2[0][5] * 100) / 100 + "<br />" +
                    "2nd best target: " + (() => { let firstChar = final2[1][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[1][0].split(""); if (firstChar[0] == "I") { return final2[1][0].substring(1) } else { return final2[1][0] } })() + ", Magnitude: " + (() => { if (final2[1][2] == "") { return "N/A" } else { return final2[1][2] } })() + ", Type: " + final2[1][3] + ", Constellation: " + final2[1][4] + ", Visability Score: " + Math.round(final2[1][5] * 100) / 100 + "<br />" +
                    "3rd best target: " + (() => { let firstChar = final2[2][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[2][0].split(""); if (firstChar[0] == "I") { return final2[2][0].substring(1) } else { return final2[2][0] } })() + ", Magnitude: " + (() => { if (final2[2][2] == "") { return "N/A" } else { return final2[2][2] } })() + ", Type: " + final2[2][3] + ", Constellation: " + final2[2][4] + ", Visability Score: " + Math.round(final2[2][5] * 100) / 100 + "<br />" +
                    "4th best target: " + (() => { let firstChar = final2[3][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[3][0].split(""); if (firstChar[0] == "I") { return final2[3][0].substring(1) } else { return final2[3][0] } })() + ", Magnitude: " + (() => { if (final2[3][2] == "") { return "N/A" } else { return final2[3][2] } })() + ", Type: " + final2[3][3] + ", Constellation: " + final2[3][4] + ", Visability Score: " + Math.round(final2[3][5] * 100) / 100 + "<br />";
            } else {
                document.getElementById("p2").innerHTML = "Favorites: <br /> <br /> Best target: " + (() => { let firstChar = final2[0][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[0][0].split(""); if (firstChar[0] == "I") { return final2[0][0].substring(1) } else { return final2[0][0] } })() + ", Magnitude: " + (() => { if (final2[0][2] == "") { return "N/A" } else { return final2[0][2] } })() + ", Type: " + final2[0][3] + ", Constellation: " + final2[0][4] + ", Visability Score: " + Math.round(final2[0][5] * 100) / 100 + "<br />" +
                    "2nd best target: " + (() => { let firstChar = final2[1][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[1][0].split(""); if (firstChar[0] == "I") { return final2[1][0].substring(1) } else { return final2[1][0] } })() + ", Magnitude: " + (() => { if (final2[1][2] == "") { return "N/A" } else { return final2[1][2] } })() + ", Type: " + final2[1][3] + ", Constellation: " + final2[1][4] + ", Visability Score: " + Math.round(final2[1][5] * 100) / 100 + "<br />" +
                    "3rd best target: " + (() => { let firstChar = final2[2][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[2][0].split(""); if (firstChar[0] == "I") { return final2[2][0].substring(1) } else { return final2[2][0] } })() + ", Magnitude: " + (() => { if (final2[2][2] == "") { return "N/A" } else { return final2[2][2] } })() + ", Type: " + final2[2][3] + ", Constellation: " + final2[2][4] + ", Visability Score: " + Math.round(final2[2][5] * 100) / 100 + "<br />" +
                    "4th best target: " + (() => { let firstChar = final2[3][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[3][0].split(""); if (firstChar[0] == "I") { return final2[3][0].substring(1) } else { return final2[3][0] } })() + ", Magnitude: " + (() => { if (final2[3][2] == "") { return "N/A" } else { return final2[3][2] } })() + ", Type: " + final2[3][3] + ", Constellation: " + final2[3][4] + ", Visability Score: " + Math.round(final2[3][5] * 100) / 100 + "<br />" +
                    "5th best target: " + (() => { let firstChar = final2[4][0].split(""); if (firstChar[0] == "I") { return "IC" } else { return "NGC" } })() + (() => { let firstChar = final2[4][0].split(""); if (firstChar[0] == "I") { return final2[4][0].substring(1) } else { return final2[4][0] } })() + ", Magnitude: " + (() => { if (final2[4][2] == "") { return "N/A" } else { return final2[4][2] } })() + ", Type: " + final2[4][3] + ", Constellation: " + final2[4][4] + ", Visability Score: " + Math.round(final2[4][5] * 100) / 100;
            }
        } else {
